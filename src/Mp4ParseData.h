...
public:
    ...
    int                        decodeFrameAt(uint32_t trackIdx, uint32_t frameIdx, MyAVFrame &frame,
...
public:
    ...
    std::vector<ExtraInfo> mExtraInfo;
    struct bc_mp4_extend_box_head_t
    {
        unsigned int magic;
